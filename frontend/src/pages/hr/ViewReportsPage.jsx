  ...
  return (
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      ...
      {cycleId && (
        ...
        >
          <Table rowKey="id" columns={columns} dataSource={participants} loading={loading} pagination={{ pageSize: 20, showSizeChanger: false, showTotal: (total) => `${total} participants` }} />
        </Card>
      )}
    </Space>
  );
