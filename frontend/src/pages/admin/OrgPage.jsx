          ...
          },
          {
            ...
            children: (
              <div style={{ padding: '0 0 16px' }}>
                {importCard}
                <Table rowKey="id" columns={listColumns} loading={loading} pagination={{ pageSize: 20, showSizeChanger: false, showTotal: (total) => `${total} people` }} size="middle"
            ...
            children: (
              <div style={{ padding: '0 0 16px' }}>
                <Table
                  ...
                  dataSource={depts}
                  pagination={{ pageSize: 20, showSizeChanger: false, showTotal: (total) => `${total} departments` }}
                  columns={[
